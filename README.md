...
The pipeline of the analysis is described and can be executed from the `NDM_workflow.R` script. A Wiki page is available in this repository to look easily at the results of this script.
...
[Andrea Sanchez-Tapia](https://github.com/AndreaSanchezTapia/) provided guidance on how to develop an R poject.
